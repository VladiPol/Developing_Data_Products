#
# Here ist the Logic for the calculation.
# To predict the under/over (dynamic) game
# score without the overtime was used 
# the rpart model (decision tree)
#
...
} # end of predict_eishockey_under_over_dynamic(...)